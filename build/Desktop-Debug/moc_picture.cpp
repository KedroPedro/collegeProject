...
namespace {
struct qt_meta_tag_ZN7PictureE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7PictureE = QtMocHelpers::stringData(
    "Picture"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7PictureE[] = {
...
Q_CONSTINIT const QMetaObject Picture::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7PictureE.offsetsAndSizes,
    qt_meta_data_ZN7PictureE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7PictureE_t,
        // Q_OBJECT / Q_GADGET
...
void *Picture::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7PictureE.stringdata0))
