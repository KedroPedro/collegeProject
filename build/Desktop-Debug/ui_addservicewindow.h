/********************************************************************************
** Form generated from reading UI file 'addservicewindow.ui'
**
...
#ifndef UI_ADDSERVICEWINDOW_H
#define UI_ADDSERVICEWINDOW_H
...
public:
    ...
    void setupUi(QDialog *AddServiceWindow)
    {
        if (AddServiceWindow->objectName().isEmpty())
            AddServiceWindow->setObjectName("AddServiceWindow");
        AddServiceWindow->resize(495, 475);
        AddServiceWindow->setMinimumSize(QSize(495, 475));
        AddServiceWindow->setMaximumSize(QSize(495, 475));
        AddServiceWindow->setStyleSheet(QString::fromUtf8("background-color:#3B8C6E"));
        gridLayout = new QGridLayout(AddServiceWindow);
        gridLayout->setObjectName("gridLayout");
        gridLayout->setContentsMargins(-1, 0, -1, -1);
        widget = new QWidget(AddServiceWindow);
...
"}"));
        ...
        PBAdd = new QPushButton(widget_15);
...
"margin: 10 25"));
        ...
        retranslateUi(AddServiceWindow);

        QMetaObject::connectSlotsByName(AddServiceWindow);
    } // setupUi
    ...
    void retranslateUi(QDialog *AddServiceWindow)
    {
        ...
        label_5->setText(QCoreApplication::translate("AddServiceWindow", "\320\246\320\265\320\275\320\260", nullptr));
        label_4->setText(QCoreApplication::translate("AddServiceWindow", "\320\224\320\273\320\270\320\275\320\260", nullptr));
        label_3->setText(QCoreApplication::translate("AddServiceWindow", "\320\236\320\277\320\270\321\201\320\260\320\275\320\270\320\265", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AddServiceWindow: public Ui_AddServiceWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDSERVICEWINDOW_H
